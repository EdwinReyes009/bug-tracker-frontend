    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center justify-center w-screen h-screen bg-yummy-800 text-white gap-4'>
                ...
                <Link to='/' className='flex items-center justify-center gap-2 font-mono border border-wihite py-2 px-5 hover:bg-yummy-600 hover:text-white transition-colors duration-300'>
                    <MdHomeFilled />
                    Go To Home
                </Link>
            </div>
